  ...
  const handleSendMail = async () => {
    try {
      await axios.post("/order/send-mail", {
        email: items.email,
        content: "Cảm ơn bạn đã gửi phản hồi",
        text: "Cảm ơn bạn đã gửi phản hồi về cho chúng tôi, chúng tôi sẽ ghi nhận ý kiến của bạn",
      });
      notifySuccess("Cảm ơn bạn đã gửi phản hồi về chúng tôi");
    } catch (error) {
      console.log(error);
    }
  };
                ...
                <div className="box-info-contact">
                  <ul className="list-info">
                    <li>
                      ...
                      <p>
                        <strong>
                          470 Đường Trần Đại Nghĩa, Hoà Hải, Ngũ Hành Sơn, Đà
                          Nẵng.
                        </strong>
                      </p>
                    </li>
                    <li>
                      <p>Email chúng tôi</p>
                      <p>
                        <strong>cuonglv.21ad@vku.udn.vn</strong>
                      </p>
                    </li>
                    <li>
                      <p>Điện thoại</p>
                      <p>
                        <strong>+84 978 213 022 </strong>
                      </p>
                    </li>
                    <li>
                      ...
                      <p>
                        <strong>
                          Thứ 2 đến Thứ 6 từ 8h đến 18h; Thứ 7 và Chủ nhật từ
                          9h30 đến 17h00{" "}
                        </strong>
                      </p>
                    </li>
