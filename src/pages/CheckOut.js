                                    ...
                                    <div className="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                                        <div className="ps-checkout__billing">
                                            ...
                                            <div className="form-group form-group--inline textarea">
                                                ...
                                                <textarea className="form-control" rows={5} placeholder="Notes about your order, e.g. special notes for delivery." defaultValue={""} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="ps-checkout__order">
                                            ...
                                            <footer>
                                                ...
                                                <div className="form-group paypal">
                                                    ...
                                                    <button className="ps-btn ps-btn--fullwidth">Place Order<i className="ps-icon-next" /></button>
                                                </div>
                                            </footer>
                                        </div>
